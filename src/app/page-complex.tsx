...
export default function Home() {
  ...
  const [descriptions, setDescriptions] = useState({ spanish: '', english: '' })
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      setSelectedImage(placeholders[Math.floor(Math.random() * placeholders.length)])
    } catch (error) {
  ...
  const generateDescriptions = async () => {
    ...
    try {
      ...
      if (data.success) {
        setDescriptions({
          spanish: data.data?.spanish || 'Esta es una imagen interesante para el aprendizaje del español.',
          english: data.data?.english || 'This is an interesting image for Spanish learning.'
        })
      }
    } catch (error) {
      ...
      setDescriptions({
        spanish: 'Esta es una hermosa imagen que podemos usar para aprender español.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              ...
              <span className="ml-4 text-sm text-gray-500">Spanish Learning through Images</span>
            </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="min-h-[400px]">
                {activeTab === 'search' && (
                  <div>
                    <h3 className="text-xl font-semibold mb-4">Welcome to Describe It!</h3>
                    <p className="text-gray-600 mb-6">
                      Search for images and generate AI-powered descriptions in Spanish and English
                ...
                {activeTab === 'descriptions' && (
                  <div className="space-y-6">
                    {descriptions.spanish ? (
                      <>
                        <div>
                          <h3 className="text-lg font-semibold mb-2 text-blue-600">Spanish Description</h3>
                          <p className="text-gray-700 bg-blue-50 p-4 rounded-lg">
                            {descriptions.spanish}
                          </p>
                        </div>
                        <div>
                          <h3 className="text-lg font-semibold mb-2 text-green-600">English Translation</h3>
                      ...
                      <div className="text-center py-12 text-gray-500">
                        ...
                        <p>No descriptions yet. Search for an image and generate descriptions to get started!</p>
                      </div>
                    )}
                  </div>
                )}
