...
export async function GET(request: NextRequest) {
  try {
    ...
    const overallDemoMode =
      services.unsplash.demoMode || services.openai.demoMode;
      ...
      services: [
        {
          ...
          reason: services.unsplash.demoMode
            ? "Using curated demo images"
            : "Connected to Unsplash API",
        },
        {
          name: "OpenAI API",
          configured: services.openai.configured,
          demoMode: services.openai.demoMode,
          reason: services.openai.demoMode
            ? "Using pre-generated descriptions"
        ...
        },
        {
          ...
          reason: services.supabase.demoMode
            ? "Using localStorage storage"
            : "Connected to Supabase",
        },
      ],
      message: overallDemoMode
    ...
    apiLogger.error("Status endpoint error:", error);
