...
const extractPhrases = async (imageUrl: string, targetLevel: string, maxPhrases: number) => {
  ...
  const mockPhrases = {
    beginner: [
      {
        phrase: "fresh fruit",
        definition: "Fruit that is recently picked and not processed or preserved",
    ...
    intermediate: [
      {
        ...
        definition: "A very busy and active place where people buy and sell goods",
        partOfSpeech: "adjective + noun",
        context: "The bustling marketplace was filled with vendors and shoppers"
      },
      {
        phrase: "vibrant atmosphere",
        definition: "An environment that is full of energy, activity, and bright colors",
        partOfSpeech: "adjective + noun",
        context: "The market had a vibrant atmosphere with music and lively conversations"
      },
      {
        phrase: "seasonal produce",
        definition: "Fruits and vegetables that are naturally available during certain times of the year",
        partOfSpeech: "adjective + noun",
        context: "The vendor specializes in seasonal produce from local farms"
      },
      {
        phrase: "haggling over prices",
        definition: "The practice of negotiating to get a better price for something",
        partOfSpeech: "gerund phrase",
        context: "Haggling over prices is common practice in traditional markets"
      },
      {
        phrase: "artisanal goods",
        definition: "Products made by hand using traditional methods, often unique or of high quality",
        partOfSpeech: "adjective + noun",
        context: "The market featured many artisanal goods from local craftspeople"
      }
    ],
    advanced: [
      {
        ...
        partOfSpeech: "noun phrase",
        context: "The international food market offered a cornucopia of flavors from around the world"
      },
      {
        phrase: "entrepreneurial spirit",
        definition: "The mindset and attitude of someone who takes initiative in business ventures",
        partOfSpeech: "adjective + noun",
        context: "The young vendors displayed remarkable entrepreneurial spirit in their market stalls"
      },
      {
        phrase: "sustainable agriculture",
        definition: "Farming practices that maintain soil health and environmental balance for future generations",
        partOfSpeech: "adjective + noun",
        context: "Many vendors promoted products from sustainable agriculture initiatives"
      },
      {
        phrase: "cultural authenticity",
        definition: "The genuine representation of traditional customs and practices of a particular culture",
        partOfSpeech: "adjective + noun",
        context: "The market maintained its cultural authenticity despite modern influences"
      },
      {
        phrase: "economic microcosm",
        definition: "A small-scale representation of larger economic principles and relationships",
        partOfSpeech: "adjective + noun",
        context: "The local market serves as an economic microcosm of supply and demand dynamics"
      }
    ]
  };
  ...
  const selectedPhrases = levelPhrases.slice(0, Math.min(maxPhrases, levelPhrases.length));
