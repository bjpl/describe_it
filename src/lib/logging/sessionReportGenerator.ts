...
Report generated by Describe It Learning Analytics
  ...
  private generateHTMLReport(
    ...
    const timeAnalysis = this.generateTimeAnalysisReport();
    const vocabularyReport = this.generateVocabularyReport();
    const sessionIdDisplay = report.summary.sessionId.split("_")[1] || report.summary.sessionId;
...
<body>
  <div class="container">
    <div class="header">
      ...
      <p>Session ${sessionIdDisplay} • Generated ${new Date(report.generatedAt).toLocaleString()}</p>
