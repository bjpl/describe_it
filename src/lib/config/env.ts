...
export interface ServerEnv {
  ...
  RUVECTOR_ENABLED?: string;
  RUVECTOR_API_KEY?: string;
  RUVECTOR_ENDPOINT?: string;
  RUVECTOR_COLLECTION_VOCABULARY?: string;
  RUVECTOR_COLLECTION_IMAGES?: string;
  RUVECTOR_COLLECTION_DESCRIPTIONS?: string;
  RUVECTOR_COLLECTION_LEARNING?: string;
  RUVECTOR_EMBEDDING_MODEL?: string;
  RUVECTOR_EMBEDDING_DIMENSIONS?: string;
  RUVECTOR_EMBEDDING_BATCH_SIZE?: string;
  RUVECTOR_SEARCH_DEFAULT_LIMIT?: string;
  RUVECTOR_SEARCH_MIN_THRESHOLD?: string;
  RUVECTOR_SEARCH_MAX_RESULTS?: string;
  RUVECTOR_CACHE_ENABLED?: string;
  RUVECTOR_CACHE_TTL_SECONDS?: string;
  RUVECTOR_CACHE_MAX_SIZE?: string;
  RUVECTOR_CACHE_SIMILARITY_THRESHOLD?: string;
  RUVECTOR_GNN_ENABLED?: string;
  RUVECTOR_GNN_TRAINING_INTERVAL?: string;
  ENABLE_VECTOR_SEARCH?: string;
  ENABLE_SEMANTIC_CACHE?: string;
  ENABLE_GNN_LEARNING?: string;
  ENABLE_KNOWLEDGE_GRAPH?: string;
}
...
export const serverEnv: ServerEnv = {
  ...
  // RuVector Configuration
  RUVECTOR_ENABLED: getEnv('RUVECTOR_ENABLED', 'false'),
  RUVECTOR_API_KEY: getEnv('RUVECTOR_API_KEY'),
  ...
  RUVECTOR_EMBEDDING_BATCH_SIZE: getEnv('RUVECTOR_EMBEDDING_BATCH_SIZE', '100'),
  RUVECTOR_SEARCH_DEFAULT_LIMIT: getEnv('RUVECTOR_SEARCH_DEFAULT_LIMIT', '20'),
  RUVECTOR_SEARCH_MIN_THRESHOLD: getEnv('RUVECTOR_SEARCH_MIN_THRESHOLD', '0.7'),
  RUVECTOR_SEARCH_MAX_RESULTS: getEnv('RUVECTOR_SEARCH_MAX_RESULTS', '100'),
  RUVECTOR_CACHE_ENABLED: getEnv('RUVECTOR_CACHE_ENABLED', 'true'),
  RUVECTOR_CACHE_TTL_SECONDS: getEnv('RUVECTOR_CACHE_TTL_SECONDS', '3600'),
  RUVECTOR_CACHE_MAX_SIZE: getEnv('RUVECTOR_CACHE_MAX_SIZE', '10000'),
  RUVECTOR_CACHE_SIMILARITY_THRESHOLD: getEnv('RUVECTOR_CACHE_SIMILARITY_THRESHOLD', '0.85'),
  RUVECTOR_GNN_ENABLED: getEnv('RUVECTOR_GNN_ENABLED', 'false'),
  RUVECTOR_GNN_TRAINING_INTERVAL: getEnv('RUVECTOR_GNN_TRAINING_INTERVAL', '86400'),
  ENABLE_VECTOR_SEARCH: getEnv('ENABLE_VECTOR_SEARCH', 'false'),
  ENABLE_SEMANTIC_CACHE: getEnv('ENABLE_SEMANTIC_CACHE', 'false'),
  ENABLE_GNN_LEARNING: getEnv('ENABLE_GNN_LEARNING', 'false'),
  ENABLE_KNOWLEDGE_GRAPH: getEnv('ENABLE_KNOWLEDGE_GRAPH', 'false'),
};
