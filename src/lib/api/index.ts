...
export const API_CONSTANTS = {
  ...
  DESCRIPTION_STYLES: ['narrativo', 'poetico', 'academico', 'conversacional', 'infantil'] as const,
  UNSPLASH_ORIENTATIONS: ['landscape', 'portrait', 'squarish'] as const,
  UNSPLASH_COLORS: ['black_and_white', 'black', 'white', 'yellow', 'orange', 'red', 'purple', 'magenta', 'green', 'teal', 'blue'] as const,
} as const;
...
export const apiHelpers = {
   ...
   */
  calculateCacheTTL(dataType: 'image' | 'description' | 'translation' | 'search'): number {
    const ttls = {
      image: 3600, // 1 hour
