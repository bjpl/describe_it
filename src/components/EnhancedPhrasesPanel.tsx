...
import { BookOpen, ChevronDown, AlertCircle, RefreshCw, Save, Bookmark, BookmarkCheck, Languages, ChevronRight, Filter, Search } from 'lucide-react';
...
const EnhancedPhrasesPanel = memo<EnhancedPhrasesPanelProps>(function EnhancedPhrasesPanel({ 
  ...
  const [expandedCategories, setExpandedCategories] = useState<Set<string>>(new Set(['sustantivos', 'verbos']));
  ...
  }, [selectedImage?.id, descriptionText, difficulty, style, extractPhrases]);
  ...
  const savePhrase = useCallback(async (phrase: CategorizedPhrase) => {
    try {
      ...
      console.log('Phrase saved:', updatedPhrase);
  ...
  // Translate phrase
  const translatePhrase = useCallback(async (phrase: CategorizedPhrase) => {
  ...
  const translateAllPhrases = useCallback(async () => {
    ...
    try {
      ...
      console.error('Error batch translating phrases:', error);
  ...
  }, [categorizedPhrases, phraseTranslations, translatingBatch, categoryFilter, searchTerm]);
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-yellow-700 dark:text-yellow-400 mt-1">
                Please generate a description first. The phrases will be categorized by grammatical type.
              </p>
            </div>
          </div>
        </div>
            ...
            <div key={category} className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
              ...
              >
                <div className="flex items-center gap-3">
                  <ChevronRight className={`h-4 w-4 transition-transform ${expandedCategories.has(category) ? 'rotate-90' : ''}`} />
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex items-start justify-between">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            >
                              {phrase.saved ? <BookmarkCheck className="h-4 w-4" /> : <Bookmark className="h-4 w-4" />}
                            </button>
                          </div>
                        </div>
