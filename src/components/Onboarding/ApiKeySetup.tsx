...
export default function ApiKeySetup({ onNext, onPrev, onSkip, className = '' }: ApiKeySetupProps) {
  ...
  const getValidationIcon = (state: ValidationState[keyof ValidationState]) => {
    switch (state) {
      case 'validating':
        return (
          <div className='animate-spin h-4 w-4 border-2 border-blue-500/30 border-t-blue-500 rounded-full' />
        );
      case 'valid':
    ...
    <div className={`flex flex-col h-full ${className}`}>
      ...
      >
        ...
        <div className='text-center mb-8'>
          ...
          >
            Connect your API keys to unlock enhanced features. Don&apos;t worry - this step is
            optional and you can always add them later in settings.
          </motion.p>
        </div>
          ...
          <div className='flex items-start space-x-3'>
            ...
            <div>
              ...
              <p className='text-sm text-blue-800 dark:text-blue-200'>
                API keys are encrypted and stored securely. They&apos;re only used to enhance your
                learning experience and are never shared with third parties.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        <div className='space-y-6 max-w-2xl mx-auto'>
          {apiKeyFields.map(field => (
            <motion.div key={field.key} variants={itemVariants} className='space-y-4'>
              <div className='bg-gray-50 dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700'>
                <div className='flex items-start justify-between mb-4'>
                  <div>
                    ...
                    <p className='text-gray-600 dark:text-gray-300 text-sm'>{field.description}</p>
                  </div>
                  <a
                    href={field.helpUrl}
                    target='_blank'
        ...
        {isCurrentUserLoggedIn && (
          <motion.div variants={itemVariants} className='max-w-2xl mx-auto mt-6'>
        ...
        >
          <p className='text-sm text-gray-600 dark:text-gray-300'>
            <strong>Don&apos;t have API keys?</strong> No problem! You can still use the app with
            demo content and add your keys later from the settings page.
          </p>
        </motion.div>
      </motion.div>
