    ...
    <div className={`w-full max-w-6xl mx-auto space-y-6 ${className}`}>
      ...
      <div className='space-y-4'>
        ...
        <div className='flex items-center justify-between'>
          <button
            ...
            className='flex items-center gap-2 px-4 py-2 text-gray-600 hover:text-gray-800 hover:bg-gray-100 rounded-lg transition-colors hover:scale-105 active:scale-95'
          >
      ...
      {error && (
        <div className='bg-red-50 border border-red-200 rounded-xl p-6 text-center'>
          ...
          <button
            ...
            className='mt-4 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors hover:scale-105 active:scale-95'
          >
            Try Again
          </button>
        </div>
      ...
      {!loading.isLoading && !error && hasResults && (
        <div className='space-y-6'>
          <ImageGrid images={images} onImageClick={handleImageClick} loading={loading.isLoading} />
      ...
      {!loading.isLoading && !error && hasQuery && !hasResults && (
        <div className='text-center py-12 space-y-4'>
          ...
          <p className='text-gray-500 max-w-md mx-auto'>
            Try different keywords or check your spelling. Popular searches include nature, people,
          ...
          <div className='flex flex-wrap justify-center gap-2 mt-6'>
            {['nature', 'people', 'city', 'food', 'animals', 'travel'].map(suggestion => (
              <button
                ...
                className='px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-full text-sm transition-colors hover:scale-105 active:scale-95'
              >
                {suggestion}
              </button>
            ))}
