...
export const FlashcardComponent: React.FC<FlashcardComponentProps> = ({
  ...
  return (
    <div className='flashcard-container focus:outline-none' tabIndex={0} onKeyDown={handleKeyPress}>
      {/* Progress bar */}
        ...
        >
          ...
          <div className='flashcard-face flashcard-front bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-600 rounded-xl p-8 shadow-lg'>
            <div className='text-center space-y-4'>
              ...
              {phrase.partOfSpeech && (
                <p className='text-sm text-gray-500 dark:text-gray-500'>{phrase.partOfSpeech}</p>
              )}
              ...
              {showHint && (
                <div className='mt-4 p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800'>
                  <p className='text-sm text-yellow-800 dark:text-yellow-300'>
                    <strong>Hint:</strong>{' '}
                    {phrase.context?.substring(0, 50) ?? 'No context available'}...
                  </p>
                </div>
              )}
