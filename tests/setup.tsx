...
vi.mock('lucide-react', () => ({
  ...
  BarChart3: ({ className = '', ...props }) => <svg data-testid="bar-chart3-icon" className={className} {...props} />,
  ...
  Trash2: ({ className = '', ...props }) => <svg data-testid="trash2-icon" className={className} {...props} />,
  ...
  ImageOff: ({ className = '', ...props }) => <svg data-testid="image-off-icon" className={className} {...props} />,
  FileText: ({ className = '', ...props }) => <svg data-testid="file-text-icon" className={className} {...props} />,
  FileUp: ({ className = '', ...props }) => <svg data-testid="file-up-icon" className={className} {...props} />,
  ...
  Share2: ({ className = '', ...props }) => <svg data-testid="share2-icon" className={className} {...props} />,
  ...
  KeyRound: ({ className = '', ...props }) => <svg data-testid="key-round-icon" className={className} {...props} />,
  ...
  // Missing icons found in codebase scan
  Award: ({ className = '', ...props }) => <svg data-testid="award-icon" className={className} {...props} />,
  Bell: ({ className = '', ...props }) => <svg data-testid="bell-icon" className={className} {...props} />,
  Bookmark: ({ className = '', ...props }) => <svg data-testid="bookmark-icon" className={className} {...props} />,
  BookmarkCheck: ({ className = '', ...props }) => <svg data-testid="bookmark-check-icon" className={className} {...props} />,
  Bug: ({ className = '', ...props }) => <svg data-testid="bug-icon" className={className} {...props} />,
  Camera: ({ className = '', ...props }) => <svg data-testid="camera-icon" className={className} {...props} />,
  CheckCircle: ({ className = '', ...props }) => <svg data-testid="check-circle-icon" className={className} {...props} />,
  Chrome: ({ className = '', ...props }) => <svg data-testid="chrome-icon" className={className} {...props} />,
  Github: ({ className = '', ...props }) => <svg data-testid="github-icon" className={className} {...props} />,
  HardDrive: ({ className = '', ...props }) => <svg data-testid="hard-drive-icon" className={className} {...props} />,
  History: ({ className = '', ...props }) => <svg data-testid="history-icon" className={className} {...props} />,
  Languages: ({ className = '', ...props }) => <svg data-testid="languages-icon" className={className} {...props} />,
  LogOut: ({ className = '', ...props }) => <svg data-testid="log-out-icon" className={className} {...props} />,
  MessageSquare: ({ className = '', ...props }) => <svg data-testid="message-square-icon" className={className} {...props} />,
  SkipForward: ({ className = '', ...props }) => <svg data-testid="skip-forward-icon" className={className} {...props} />,
  Sparkles: ({ className = '', ...props }) => <svg data-testid="sparkles-icon" className={className} {...props} />,
  Trophy: ({ className = '', ...props }) => <svg data-testid="trophy-icon" className={className} {...props} />,
  XCircle: ({ className = '', ...props }) => <svg data-testid="x-circle-icon" className={className} {...props} />,
}));
